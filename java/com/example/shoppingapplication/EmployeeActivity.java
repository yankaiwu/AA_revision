...
import com.example.shoppingapplication.ButtonController.UpdateInventoryButtonController;
...
public class EmployeeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button updateInventoryButton = findViewById(R.id.updateInventoryButton);
        updateInventoryButton.setOnClickListener(new UpdateInventoryButtonController(this));
